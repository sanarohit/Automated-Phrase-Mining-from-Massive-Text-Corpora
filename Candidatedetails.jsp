...
<!--<%
 int neagative=pb.getCount()-size;
  out.println("Negative Pool"+neagative);
 out.println("Positive Pool"+size);
 out.println("total Pool"+pb.getCount());
  %>
...
<font color="green"><%=pb.getAccesspoint()%></font>
  ...
  -->
  <td>
<a href="Viewcandidatedataservlet?cid=<%=pb.getCid()%>"><%=pb.getTopicname()%></a>
 </td>
 </tr>
