...
#myTable tr.header, #myTable tr:hover {
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     ...
     %>
   <center><br/><h2><font face="Yu Mincho Demibold" style="color: #00BFFF;"><font size="8" >View&nbsp; Auto Phrase Mining<br></font></font></h2></center>
...
<th style="width:20%; color:#8B0000">USER_NAME</th>
 <th style="width:20%; color:#8B0000">CANDIDATE_NAME</th>
 <th style="width:20%; color:#8B0000">Searched_DATE</th>
 <th style="width:20%; color:#8B0000">TOPIC_NAME</th>
 <th style="width:20%; color:#8B0000">View</th>
...
<td>
  ...
  <font color="green"><%=pb.getCandidatename()%></font>
   ...
   <td>
<font color="green"><%=pb.getSearchdate()%></font>
 </td>
...
<font color="green"><%=pb.getTopicname()%></font>
  ...
  <td>
<a href="Viewautophraseminingservlet?cid=<%=pb.getCid()%>"><%=pb.getTopicname()%></a>
 </td>
