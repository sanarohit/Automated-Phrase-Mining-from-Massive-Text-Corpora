...
#myTable tr.header, #myTable tr:hover {
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     ...
     %>
   <center><br/><h2><font face="Yu Mincho Demibold" style="color: #00BFFF;"><font size="8" >View&nbsp; PhraseMining<br></font></font></h2></center>
...
<font color="green"><%=pb.getSearchdate()%></font>
  ...
  <td>
<a href="Viewphraseminingdetailsservlet?cid=<%=pb.getCid()%>">View</a>
 </td>
