...
public class Searchmyhistoryservlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			ArrayList<Profilebean> list=sfcd.searchhistory(userid);
		
			session.setAttribute("list", list);
			RequestDispatcher rd=request.getRequestDispatcher("searchedhistory.jsp");
