...
public class Viewcandidatedataservlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
		ArrayList<Profilebean> list=sfcd.getdetails(cid);	
		...
		RequestDispatcher rd=request.getRequestDispatcher("Candidatedata.jsp");
