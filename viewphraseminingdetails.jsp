...
#myTable tr.header, #myTable tr:hover {
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     ...
     %>
   <center><br/><h2><font face="Yu Mincho Demibold" style="color: #00BFFF;"><font size="8" >View&nbsp; Phrase Mining<br></font></font></h2></center>
...
<th style="width:20%; color:#8B0000">CID</th>
 ...
 <th style="width:20%; color:#8B0000">UPLOAD_DATE</th>
